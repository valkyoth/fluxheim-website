...
async fn renders_default_english_home() {
    ...
    assert!(body.contains("Download v1.7.12"));
...
async fn locale_prefixes_preserve_legacy_pages() {
    ...
    assert!(ch_body.contains("Herunterladen v1.7.12"));
    ...
    assert!(sv_body.contains("Ladda ner v1.7.12"));
    ...
    assert!(nb_body.contains("Last ned v1.7.12"));
    ...
    assert!(nl_body.contains("Download versie 1.7.12"));
    ...
    assert!(fi_body.contains("Lataa v1.7.12"));
    ...
    assert!(is_body.contains("Sækja v1.7.12"));
    ...
    assert!(da_body.contains("Hent v1.7.12"));
    ...
    assert!(es_body.contains("Descargar v1.7.12"));
    ...
    assert!(pt_body.contains("Transferir v1.7.12"));
    ...
    assert!(et_body.contains("Laadi alla v1.7.12"));
    ...
    assert!(lv_body.contains("Lejupielādēt v1.7.12"));
    ...
    assert!(el_body.contains("Λήψη v1.7.12"));
    ...
    assert!(it_body.contains("Scarica v1.7.12"));
    ...
    assert!(lt_body.contains("Atsisiųsti v1.7.12"));
    ...
    assert!(hr_body.contains("Preuzmi v1.7.12"));
    ...
    assert!(cs_body.contains("Stáhnout v1.7.12"));
    ...
    assert!(bs_body.contains("Preuzmi v1.7.12"));
    ...
    assert!(bg_body.contains("Изтегли v1.7.12"));
    ...
    assert!(ro_body.contains("Descarcă v1.7.12"));
    ...
    assert!(pl_body.contains("Pobierz v1.7.12"));
    ...
    assert!(ru_body.contains("Скачать v1.7.12"));
    ...
    assert!(ja_body.contains("ダウンロード v1.7.12"));
    ...
    assert!(ko_body.contains("v1.7.12 다운로드"));
    ...
    assert!(hu_body.contains("v1.7.12 letöltése"));
...
async fn english_variant_prefixes_preserve_english_content() {
    ...
    assert!(gb_body.contains("Download v1.7.12"));
    assert!(gb_body.contains("Pre-built Linux binaries"));
    assert!(gb_body.contains("Released 15 July 2026"));
    assert!(!gb_body.contains("Released July 15, 2026"));
    ...
    assert!(us_download_body.contains("Released July 15, 2026"));
    assert!(!us_download_body.contains("Released 15 July 2026"));
}
...
async fn locale_prefixes_apply_runtime_translations() {
    ...
    assert!(fr_body.contains("Télécharger v1.7.12"));
