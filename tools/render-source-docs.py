...
DOCS = {
    ...
    "runtime-baseline.md": "Runtime Baseline",
    "runtime-parity-fixtures.md": "Runtime Parity Fixtures",
    "modularity-policy.md": "Modularity Policy",
    "modularity-exceptions.md": "Modularity Exceptions",
    "extraction-dependency-graph.md": "Extraction Dependency Graph",
    "runtime-facts-and-policy-proofs.md": "Runtime Facts And Policy Proofs",
    ...
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex items-center gap-6">
          ...
          <a href="../../download.html" class="px-4 py-2 bg-cyan-500 hover:bg-cyan-400 text-gray-950 text-sm font-bold rounded-lg transition-colors">Download v1.6.13</a>
        </div>
