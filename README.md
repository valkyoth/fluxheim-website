...
The site is self-hosting: the included `container/Dockerfile` builds Fluxheim v1.4.0 from source and serves this website from inside a hardened Wolfi container.
...
1. **Builder** — `rust:1.95-slim-bookworm`: clones and compiles Fluxheim v1.4.0 with `profile-static-site`
...
podman build -f container/Dockerfile -t fluxheim-website:1.4.0 .
