...
The site is self-hosting: the included `container/Dockerfile` builds Fluxheim v1.5.7 from source and serves this website from inside a hardened Wolfi container.
...
1. **Builder** — `rust:1.96-slim-bookworm`: clones and compiles Fluxheim v1.5.7 with `profile-static-site`
...
podman build -f container/Dockerfile -t fluxheim-website:1.5.7 .
