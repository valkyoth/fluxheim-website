...
case "$i18n_progress" in
  *"de-DE:"*"fr-FR:"*"sv-SE:"*"nb-NO:"*"nl-NL:"*"fi-FI:"*"is-IS:"*"da-DK:"*"es-ES:"*"pt-PT:"*"et-EE:"*"lv-LV:"*"el-GR:"*"it-IT:"*"lt-LT:"*"hr-HR:"*"cs-CZ:"*"bs-BA:"*"bg-BG:"*"de-CH:"*"ro-RO:"*"pl-PL:"*"ru-RU:"*"ja-JP:"*) ;;
  *)
