...
mod tests {
    ...
    #[test]
    fn translates_german_shell_text() {
        let site = Site::load().expect("site loads");
        let locale = site.locale("de-DE").expect("German locale");
        let html = r#"<html lang="en"><body>Docs Download Changelog Memory-Safe Edge Server Built in Rust</body></html>"#;
        ...
        assert!(translated.contains("Speichersicher"));
    }

    #[test]
    fn translates_french_shell_text() {
        let site = Site::load().expect("site loads");
    ...
    fn translates_page_specific_bundle_text() {
        let site = Site::load().expect("site loads");
        let locale = site.locale("de-DE").expect("German locale");
        let html = r#"<html lang="en"><body>Cache Edge Build</body></html>"#;
        let translated = translate_html(locale, html.to_owned());
