...
- `v1.5.21-wolfi`, `v1.5.21-alpine`, `v1.5.21-suse-micro`, `v1.5.21-debian`
...
- `v1.5.21-cache-wolfi`, `v1.5.21-cache-alpine`,
  `v1.5.21-cache-suse-micro`, `v1.5.21-cache-debian`
- `v1.5.21-proxy-wolfi`, `v1.5.21-proxy-alpine`,
  `v1.5.21-proxy-suse-micro`, `v1.5.21-proxy-debian`
- `v1.5.21-load-balancer-wolfi`, `v1.5.21-load-balancer-alpine`,
  `v1.5.21-load-balancer-suse-micro`, `v1.5.21-load-balancer-debian`
- `v1.5.21-php-wolfi`, `v1.5.21-php-alpine`,
  `v1.5.21-php-suse-micro`, `v1.5.21-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.5.21-cache`, `v1.5.21-proxy`,
  `v1.5.21-load-balancer`, `v1.5.21-php`, `latest-cache`, `latest-proxy`,
