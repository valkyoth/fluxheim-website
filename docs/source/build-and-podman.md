...
Fluxheim pins Rust 1.96.1 in `rust-toolchain.toml` and `Cargo.toml`. The local
...
Fluxheim builds with Rust 1.96.1. Starting in `1.6.34`, the default feature set
...
- Rust 1.96.1, usually through `rustup` or the distro Rust packages when they
  are new enough;
...
`1.96.1-alpine3.23` image to keep a musl-linked release binary portable across
small runtime bases. The Debian variant builds with the official Rust
`1.96.1-bookworm` image and runs on `debian:trixie-slim`.
...
- `v1.7.3-wolfi`, `v1.7.3-alpine`, `v1.7.3-suse-micro`, `v1.7.3-debian`
...
- `v1.7.3-cache-wolfi`, `v1.7.3-cache-alpine`,
  `v1.7.3-cache-suse-micro`, `v1.7.3-cache-debian`
- `v1.7.3-proxy-wolfi`, `v1.7.3-proxy-alpine`,
  `v1.7.3-proxy-suse-micro`, `v1.7.3-proxy-debian`
- `v1.7.3-load-balancer-wolfi`, `v1.7.3-load-balancer-alpine`,
  `v1.7.3-load-balancer-suse-micro`, `v1.7.3-load-balancer-debian`
- `v1.7.3-php-wolfi`, `v1.7.3-php-alpine`,
  `v1.7.3-php-suse-micro`, `v1.7.3-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.7.3-cache`, `v1.7.3-proxy`,
  `v1.7.3-load-balancer`, `v1.7.3-php`, `latest-cache`, `latest-proxy`,
