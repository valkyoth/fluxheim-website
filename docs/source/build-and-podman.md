...
- `v1.5.20-wolfi`, `v1.5.20-alpine`, `v1.5.20-suse-micro`, `v1.5.20-debian`
...
- `v1.5.20-cache-wolfi`, `v1.5.20-cache-alpine`,
  `v1.5.20-cache-suse-micro`, `v1.5.20-cache-debian`
- `v1.5.20-proxy-wolfi`, `v1.5.20-proxy-alpine`,
  `v1.5.20-proxy-suse-micro`, `v1.5.20-proxy-debian`
- `v1.5.20-load-balancer-wolfi`, `v1.5.20-load-balancer-alpine`,
  `v1.5.20-load-balancer-suse-micro`, `v1.5.20-load-balancer-debian`
- `v1.5.20-php-wolfi`, `v1.5.20-php-alpine`,
  `v1.5.20-php-suse-micro`, `v1.5.20-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.5.20-cache`, `v1.5.20-proxy`,
  `v1.5.20-load-balancer`, `v1.5.20-php`, `latest-cache`, `latest-proxy`,
