...
- `v1.5.22-wolfi`, `v1.5.22-alpine`, `v1.5.22-suse-micro`, `v1.5.22-debian`
...
- `v1.5.22-cache-wolfi`, `v1.5.22-cache-alpine`,
  `v1.5.22-cache-suse-micro`, `v1.5.22-cache-debian`
- `v1.5.22-proxy-wolfi`, `v1.5.22-proxy-alpine`,
  `v1.5.22-proxy-suse-micro`, `v1.5.22-proxy-debian`
- `v1.5.22-load-balancer-wolfi`, `v1.5.22-load-balancer-alpine`,
  `v1.5.22-load-balancer-suse-micro`, `v1.5.22-load-balancer-debian`
- `v1.5.22-php-wolfi`, `v1.5.22-php-alpine`,
  `v1.5.22-php-suse-micro`, `v1.5.22-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.5.22-cache`, `v1.5.22-proxy`,
  `v1.5.22-load-balancer`, `v1.5.22-php`, `latest-cache`, `latest-proxy`,
